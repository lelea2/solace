...
import AnalogClock from "@/components/ui-prototype/analog-clock/AnologClock";

export const metadata = {
  title: "Analog Clock — UI Prototype",
  description: "A simple analog clock component prototype.",
};
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <p className="text-slate-400 text-sm font-mono tracking-widest uppercase mb-4">
          UI Prototype · Analog Clock
        </p>
        <h1 className="text-4xl font-bold tracking-tight mb-3">Analog Clock</h1>
        <p className="text-slate-400 text-lg mb-16">
          A simple analog clock component.
        </p>
