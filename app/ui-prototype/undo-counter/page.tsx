...
import UndoCounter from "@/components/ui-prototype/undo-counter/UndoCounter";

export const metadata = {
  title: "Undoable Counter — UI Prototype",
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <p className="text-slate-400 text-sm font-mono tracking-widest uppercase mb-4">
          UI Prototype · Undoable Counter
        </p>
        <h1 className="text-4xl font-bold tracking-tight mb-3">Undoable Counter</h1>
        <p className="text-slate-400 text-lg mb-16">
          A simple undoable counter.
        </p>
