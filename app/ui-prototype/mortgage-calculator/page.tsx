...
import MortgageCalculator from "@/components/ui-prototype/mortgage-calculator/MortgageCalculator";

export const metadata = {
  title: "Mortgage Calculator — UI Prototype",
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <p className="text-slate-400 text-sm font-mono tracking-widest uppercase mb-4">
          UI Prototype · Mortgage Calculator
        </p>
        <h1 className="text-4xl font-bold tracking-tight mb-3">Mortgage Calculator</h1>
