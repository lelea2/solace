...
import AuthInput from "@/components/ui-prototype/auth-input/AuthInput";

export const metadata = {
  title: "Auth Input — UI Prototype",
  description: "A simple auth input component prototype.",
};
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <p className="text-slate-400 text-sm font-mono tracking-widest uppercase mb-4">
          UI Prototype · Auth Input
        </p>
        <h1 className="text-4xl font-bold tracking-tight mb-3">Auth Input</h1>
        <p className="text-slate-400 text-lg mb-16">
          A simple auth input component.
        </p>
